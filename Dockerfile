...
ARG POCKETBASE_SUPERUSER_PASSWORD
ARG POCKETBASE_URL
ARG POCKETBASE_SUPERUSER_EMAIL

ENV POCKETBASE_SUPERUSER_PASSWORD=$POCKETBASE_SUPERUSER_PASSWORD
ENV POCKETBASE_URL=$POCKETBASE_URL
ENV POCKETBASE_SUPERUSER_EMAIL=$POCKETBASE_SUPERUSER_EMAIL
