      ...
      <div>
        ...
        <section>
          ...
          <ul class="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <li>
              Attempt to decompile or reverse engineer any software contained on Retro Ranker
            </li>
            <li>
        ...
        <section>
          ...
          <p class="mb-4">
            ...
            arising out of the use or inability to use the materials on Retro Ranker, even if Retro
            Ranker or a Retro Ranker authorized representative has been notified orally or in
        ...
        <section>
          ...
          <p class="mb-4">
            ...
            imply endorsement by Retro Ranker of the site. Use of any such linked website is at the
            user's own risk.
          </p>
        </section>
        ...
        <section>
          ...
          <p class="mb-4">
            Retro Ranker may revise these terms of service at any time without notice. By using this
